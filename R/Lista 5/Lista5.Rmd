...
Inicialmente, para evitar a repetição de **labs** desnecessários, resolvi alterar o nome das variáveis mais frequentes dos *databases*, para assim, os rotulos dos eixos aparecerem de forma correta, sem necessidade de usar o label. Para isso, user o comando **rename** do *dplyr*.
